...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private String ipaddress = "http://10.0.2.2:8080";
    ...
    private void login() {
        ...
        Thread loginRunnable = new Thread() {
            ...
            public void run() {
                ...
                final int id = Integer.parseInt(getAccount());
                ...
                LoginService request = retrofit.create(LoginService.class);

                User u = new User(id,"null", password);
                Call<LoginReceive> call = request.checkUser(u);
                ...
                call.enqueue(new Callback<LoginReceive>() {
                    ...
                    public void onResponse(Call<LoginReceive> call, Response<LoginReceive> response) {
                        ...
                        if(response.body().getStatus()) {
                            ...
                            usr.setUserName(response.body().getName());
                            usr.setUserid(response.body().getUserid());
                            loadCheckBoxState();//记录下当前用户记住密码和自动登录的状态;
                            usr.setLogined(1);

//                            usr.setSubjectid(response.body().getSubjectid());
//                            usr.setSubjectname(response.body().getSubjectname());
                    ...
                    //请求失败时回调
                    @Override
                    public void onFailure(Call<LoginReceive> call, Throwable throwable) {
    ...
    public void loadUserName() {
        if (!getAccount().equals("") || !getAccount().equals("Enter account please")) {
            SharedPreferencesUtils helper = new SharedPreferencesUtils(this, "setting");
